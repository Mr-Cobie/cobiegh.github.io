...
<html lang="en">
  <head>
    ...
    <title> MacBook Pro - brand new day for business &middot; Unistore &middot; Responsive E-Commerce Template</title>
  ...
  <body>
    ...
    <div class="blog-item">
      ...
      <div class="tiles">
        <a href="#video" data-gallery="#video" data-source="youtube" data-id="uf7U3Y2DFCA">
          <hr class="offset-lg visible-sm">
          <img src="../assets/img/blog/item-video.jpg" alt="MacBook Pro" class="hidden-xs"/>
          <img src="../assets/img/blog/item-video-xs.jpg" alt="Apple 3D Touch" class="visible-xs" />
          ...
          <div class="content">
            <div class="content-outside">
              <div class="content-inside">
                ...
                <h1>MacBook Pro <br> brand new day for business</h1>
              </div>
            </div>
          </div>
        </a>
